...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtTamaño = (gcnew System::Windows::Forms::TextBox());
			...
			this->label3->Text = L"Ingrese tamaño del arreglo ";
			// 
			// txtTamaño
			// 
			this->txtTamaño->Location = System::Drawing::Point(260, 84);
			this->txtTamaño->Name = L"txtTamaño";
			this->txtTamaño->Size = System::Drawing::Size(127, 22);
...
#pragma endregion
		...
		void creaciondevector() {
			...
			Vector = gcnew array<int>(Convert::ToInt16(txtTamaño->Text));

			for (int i = 0; i < Vector->Length; i++)
			{
				Vector[i] = r->Next(0, int::Parse(txtTamaño->Text + 1));		
			}
		...
		int BusquedaHash(array<int>^ vec,int tamaño,int valor) {

			if (vec[valor%tamaño]==valor)
			{
				return (valor & tamaño);
			}
			else
...
private: System::Void BSecuencial_Click(System::Object^ sender, System::EventArgs^ e) {
	creaciondevector();
	MessageBox::Show("El dato buscado esta en la posición: " + Bussecuencial(), "Dato buscado",MessageBoxButtons::OK, MessageBoxIcon::Information);
	
}

private: System::Void BBinario_Click(System::Object^ sender, System::EventArgs^ e) {
	creaciondevector();
	MessageBox::Show("El dato buscado esta en la posición:" + busquedaBinaria(Vector, 0, Vector->Length - 1, int::Parse(txtNbuscado->Text)), "Dato buscado", MessageBoxButtons::OK, MessageBoxIcon::Information);

}
private: System::Void BHash_Click(System::Object^ sender, System::EventArgs^ e) {
	creaciondevector();
	MessageBox::Show("El dato buscado esta en la posición:" + BusquedaHash(Vector,int::Parse(txtTamaño->Text), int::Parse(txtNbuscado->Text)), "Dato buscado", MessageBoxButtons::OK, MessageBoxIcon::Information);
}
};
}
